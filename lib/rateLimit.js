...
export const loginLimiter = new RateLimiter(900000, 3);

// Register endpoint: 3 per 1 hour
export const registerLimiter = new RateLimiter(3600000, 3);

// API endpoint: 100 per 15 minutes
export const apiLimiter = new RateLimiter(900000, 100);

// Payment endpoint: 10 per 1 hour
export const paymentLimiter = new RateLimiter(3600000, 10);
