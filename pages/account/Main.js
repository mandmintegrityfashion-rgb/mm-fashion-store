...
export default function AccountMainPage() {
  ...
  return (
    <main className="w-full lg:w-full flex flex-col gap-12 px-4 lg:px-0">
      {/* 🔹 Account Overview */}
      <section className="bg-white shadow-sm border border-blue-200 rounded-lg p-6">
            ...
            {editingAddress ? (
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[#4C9EFF] text-sm hover:underline"
                >
                  Edit
                </button>
              </div>
      ...
      <section className="bg-[#E6F0FA] py-12 rounded-lg">
        <div className="flex items-center justify-between mb-8 px-6">
          ...
          <button className="text-[#4C9EFF] hover:underline text-sm">
            See All →
          </button>
        </div>
            ...
            {moreVisible < recommendedProducts.length && (
              <div className="text-center mt-8">
                <button
                  ...
                  className="px-6 py-2 rounded-lg bg-[#1A5DAB] text-white font-semibold hover:bg-[#2B5EBF] transition"
                >
                  View More
                </button>
              </div>
